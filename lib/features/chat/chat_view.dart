...
class _ChatViewState extends ConsumerState<ChatView> {
  ...
  Widget _buildMessageList(Character character) {
    final showTimestamps =
        ref.watch(settingsProvider).valueOrNull?.showTimestamps ?? true;
    ...
    return messagesAsync.when(
      ...
      data: (messages) {
        ...
        final displayMessages = totalMessages > _visibleMessageCount
            ...
            : messages;
        _hasMoreMessages = totalMessages > _visibleMessageCount;
  ...
  Widget _buildInputArea(BuildContext context, bool isDark) {
    ...
    return ChatInput(
      ...
      currentModel: ref.watch(settingsProvider).valueOrNull?.model ?? '',
