...
/// 空状态图标呼吸动画 — 对应主项目 `.empty-breathe`
class EmptyBreathe extends StatefulWidget {
  final Widget child;

  const EmptyBreathe({super.key, required this.child});

  @override
  State<EmptyBreathe> createState() => _EmptyBreatheState();
}

class _EmptyBreatheState extends State<EmptyBreathe>
