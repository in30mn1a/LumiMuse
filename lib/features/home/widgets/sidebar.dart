...
///     字体使用 var(--font-display) = Quicksand。**绝不**用渐变 ShaderMask
...
class _SidebarState extends ConsumerState<Sidebar> {
  ...
  Widget build(BuildContext context) {
    ...
    final showSearchPanel =
        _searchFocused && _lastQuery.trim().isNotEmpty;
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius:
                    BorderRadius.circular(17.6), // 1.1rem
                boxShadow: const [
            ...
            // 标题：纯色 text-primary，font-display = Quicksand，tracking-tight
            Text(
              'LumiMuse',
              style: GoogleFonts.quicksand(
                fontSize: 24, // text-[1.5rem]
                fontWeight: FontWeight.w600, // font-semibold
                letterSpacing: -0.6, // tracking-tight ≈ -0.025em * 24
                color: isDark
  ...
  void _openMemories(BuildContext context) {
    ...
    if (selection.characterId != null) {
      context.push('/memories/${selection.characterId}');
      return;
    }
...
class _SearchResultRowState extends State<_SearchResultRow> {
  ...
  Widget build(BuildContext context) {
    ...
    final accentDark =
        widget.isDark ? AppTheme.darkAccentDark : AppTheme.accentDark;
    final primary =
