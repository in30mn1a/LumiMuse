...
class AppSurfaces {
  ...
  static BoxDecoration panel({bool isDark = false, Brightness? mode}) {
  ...
  static BoxDecoration panelQuiet({bool isDark = false, Brightness? mode}) {
    final dark = _resolveDark(mode: mode, isDark: isDark);
    return BoxDecoration(
      color: dark
  ...
  static BoxDecoration card({bool isDark = false, Brightness? mode}) {
    final dark = _resolveDark(mode: mode, isDark: isDark);
    return BoxDecoration(
      color: dark
  ...
  static BoxDecoration hero({bool isDark = false, Brightness? mode}) {
    final dark = _resolveDark(mode: mode, isDark: isDark);
    return BoxDecoration(
