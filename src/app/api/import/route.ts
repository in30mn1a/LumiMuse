...
import { serializePromptMap, serializeReasoningMap } from '@/lib/character-task-models';
  ...
  const importAll = db.transaction(() => {
    ...
    for (const char of charactersToImport) {
      ...
      insertCharacter.run(
        ...
        asString(char.background_provider_id),
        serializeReasoningMap(char.background_reasoning_by_model),
        serializeReasoningMap(char.image_prompt_reasoning_by_model),
        serializePromptMap(char.background_system_prompt_by_model),
        serializePromptMap(char.image_prompt_system_prompt_by_model),
      );
      results.imported++;
    }
