      ...
      <div className="mt-4 flex flex-col gap-2">
        {options.map(option => (
          <button
            ...
            className="soft-button soft-button-secondary w-full flex-col items-start gap-1 px-4 py-3 text-left"
          >
            <span className="font-medium">{option.title}</span>
            <span className="section-copy text-xs leading-relaxed opacity-80">{option.desc}</span>
          </button>
        ))}
      </div>
