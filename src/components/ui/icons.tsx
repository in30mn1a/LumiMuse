...
export function PinIcon(props: IconProps) {
  return (
    <BaseIcon {...props}>
      <path d="M12 2l.3.4 3.2 4.3 4.5.6a1 1 0 0 1 .6 1.7l-3.3 3.2.8 4.5a1 1 0 0 1-1.5 1.1L12 15.6l-4.6 2.4a1 1 0 0 1-1.5-1.1l.8-4.5-3.3-3.2a1 1 0 0 1 .6-1.7l4.5-.6 3.2-4.3.3-.4z" />
    </BaseIcon>
  );
}
