...
const allowedDirectJsonRoutes = [
  ...
  'src/app/api/prompt-presets/[id]/entries/[entryId]/route.ts',
  'src/app/api/prompt-presets/[id]/entries/route.ts',
  'src/app/api/prompt-presets/[id]/route.ts',
  'src/app/api/prompt-presets/import/route.ts',
  'src/app/api/prompt-presets/route.ts',
